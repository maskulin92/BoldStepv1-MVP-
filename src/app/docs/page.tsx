...
const GROUPS: { title: string; note: string; rows: [string, string, string][] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['PUT', '/api/clients/{clientId}', 'Update a client (owner only)'],
      ['GET', '/api/campaigns/{clientId}', 'Campaigns with per-campaign totals'],
      ['GET', '/api/campaigns/{clientId}/{campaignId}', 'Ad sets, 7d/30d insights, open actions'],
    ],
  },
  {
    title: 'Insights & sync',
    ...
    rows: [
      ['GET', '/api/meta/insights/{clientId}', 'Daily insights, trend and summary'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['GET', '/api/creatives/{clientId}', 'Creative library'],
      ...
      ['GET', '/api/manual-entry/{clientId}', 'Manual entry history'],
  ...
  },
  {
    ...
    rows: [
      ...
      ['GET', '/api/integrations/export/campaigns/{clientId}', 'Export campaigns (json|csv)'],
      ['GET', '/api/integrations/export/insights/{clientId}', 'Export insights (json|csv)'],
